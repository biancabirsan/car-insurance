...
<header>
            ...
            <nav>
                <ul>
                    ...
                    <li class="current"><a href="index.php" id="index">Get a quote</a></li>
                   </class>
       ...
       <div class="header2">
        ...
        Model<br><select name="model" div class="custom-select"  value="<?php $_POST['model']?>" action="index.php">
                        <?php  
        ...
        Engine size<br><select name="size" div class="custom-select"  value="<?php $_POST['size']?>">
